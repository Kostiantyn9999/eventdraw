...
/* @var $model common\models\NewStensils */

$this->title = 'User Stencil Versions: ' . $model->stencilName;
$this->params['breadcrumbs'][] = ['label' => 'NewStencils', 'url' => ['index']];
...
$s3 = Yii::$app->get('s3');
$filename_looking = 'eventdraw_data/new_stencils/' .  $model->ID . '.xml';
...
<div class="user-update">
    ...
    <div class="row">
        <div class="col-lg-5">
            ...
            <?= $form->field($model, 'stencil_version')->dropDownList($items)?>
