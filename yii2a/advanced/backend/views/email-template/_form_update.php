...
<div class="template-form">
    ...
    <form id="bulk-mail-out-form" action="<?= Url::to(['/email-template/updates/?id='.$getData->id]) ?>"  method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-6 form-group">
                ...
                <select class="form-control" name="template_type">
                    ...
                    <option value="welcome-template" <?php if($getData->template_type=='welcome-template') echo 'selected'?>>Welcome Template</option>
                    <option value="notify_user_bulletin" <?php if($getData->template_type=='notify_user_bulletin') echo 'selected'?>>Template Change Bulletin</option>
                    <option value="notify_user_email" <?php if($getData->template_type=='notify_user_email') echo 'selected'?>>Template Change Email</option>
                </select>
            </div>
            <div class="col-md-6 form-group">
