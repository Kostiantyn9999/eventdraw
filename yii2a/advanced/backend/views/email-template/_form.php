        ...
        <div class="row">
            <div class="col-md-6 form-group">
                ...
                <select class="form-control" name="template_type">
                    ...
                    <option value="bulletin-template">Bulletin Template</option>
                    <option value="welcome-template">Welcome Template</option>
                    <option value="notify_user_bulletin">Template Change Bulletin</option>
                    <option value="notify_user_email">Template Change Email</option>
                </select>
            </div>
            <div class="col-md-6 form-group">
            ...
            <div class="col-md-6 form-group">
                ...
                <input type="text" name="bulletin_heading" class="form-control" placeholder="Bulletin Heading">
