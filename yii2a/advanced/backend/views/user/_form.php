...
?>
    ...
    <div class="user-form">
        ...
        <div class="row">
            <div class="col-md-3">
                <?= $form->field($model, 'status')->dropDownList(['10' => 'Full Version', '9' => 'Trial', '11' => 'Custom Trial', '0' => 'No Access', '12' => 'Churn', '13' => 'Archive']) ?>
            </div>
            <div class="col-md-3">
        ...
        <div class="col-sm-3">  
            <?= $form->field($model, 'UserDoNotEmail')->checkbox([
                'template' => '<div class="col-md-1">{label}</div><div class="col-md-5">{input}</div><div class="col-md-6">{error}</div>'
            ]) ?>
        </div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="container-items">
                ...
                <?php if ($modelSettings) : ?>
                    <div class="row">
                        <?= Html::encode('Local Directory:  ' . $modelSettings->getLocalDirName($modelSettings->localDir)) ?>
                    </div>
                <?php endif; ?>
            </div>
        </div>
