...
class AdminUserSearch extends User
{
    ...
    {
        return [
            [['id', 'maxSession', 'totSession', 'clientid', 'status', 'created_at', 'updated_at', 'last_login', 'userIsAdmin', 'userIsSupport', 'userPayment', 'company_admin', 'ShowMaxCapPlans', 'is_subscribed', 'email_count','userType','AllowSaveCloud','userSavedFloorplansCount'], 'integer'],
