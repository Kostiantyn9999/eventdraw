...
class Dimension extends SceneComponent {
  inputs = {
    xMin: 0,
    xMax: 1,
    yMin: 0,
  ...
  makeDimension() {
    ...
    this.root.add(this.xline);
    this.root.add(this.yline);
  }
